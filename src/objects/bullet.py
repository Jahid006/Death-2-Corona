...
class Bullet(Sprite):
    """A Class to manage bullet from vaccine"""

    def __init__(self, game_settings, screen, vaccine):
        super().__init__()
        ...
        self.rect.centerx = vaccine.rect.centerx

        self.rect.top = vaccine.rect.top
